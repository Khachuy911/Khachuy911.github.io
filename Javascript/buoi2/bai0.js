...
// const listBalance = listAccounts.filter(function(value){
...
// const newListAccount = listAccounts.map(function(item){
// 	delete item.id;
...
const totalBalance = listAccounts.reduce(function (index, value) {
  return index + value.balance
}, 0)
...
// thống kê theo tuổi
const statisticsByAge = listPersons.reduce(function( value,index) {
   index.age<=18 ? value.treCon++ : index.age<=30 ? value.thanhNien++ : value.nguoiGia++;
   return value;
}, {
  treCon: 0,
  thanhNien: 0,
